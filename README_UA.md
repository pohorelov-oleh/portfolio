...
.NET-розробник із 2-річним досвідом у проєктуванні та розробці веб-застосунків на базі ASP.NET Core, Entity Framework Core та MSSQL Server. Успішно автоматизував бізнес-процеси, зменшуючи час і кількість помилок у виробничому середовищі.
